...
@EnableJpaRepositories(basePackages = "com.test.multiple.sources.multiple_data_sources.dao.user", 
...
public class PersistenceUserAutoConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean userEntityManager() {
        ...
        em.setPackagesToScan("com.test.multiple.sources.multiple_data_sources.model.user");
